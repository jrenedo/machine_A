...
R_1=21.6*10^-3; % [m] rotor radius
R_2=27.1*10^-3; % [m] magnet radius
R_3=31*10^-3; % [m] stator radius
R_4=53.5*10^-3; % [m] outer radius

L=125*10^-3; % [m] axial length
